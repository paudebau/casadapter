...
define('H2O_VERSION', '0.3.1');
defined('DS') or define('DS', DIRECTORY_SEPARATOR);
defined('H2O_ROOT') or define('H2O_ROOT', __DIR__ . '/h2o');

require H2O_ROOT . '/datatype.php';
require H2O_ROOT . '/loaders.php';
require H2O_ROOT . '/nodes.php';
require H2O_ROOT . '/tags.php';
require H2O_ROOT . '/errors.php';
require H2O_ROOT . '/filters.php';
require H2O_ROOT . '/context.php';
...
class H2o {
    ...
    static function load($extension, $file = null) {
        if (!$file) {
            $file = H2O_ROOT . "/ext/$extension..php";
        }
        if (is_file($file)) {
            include_once ($file);
